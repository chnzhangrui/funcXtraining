...
python train.py    -i ../input/dataset1/dataset_1_photons_1.hdf5 -o ../output/dataset1/v2/
python evaluate.py -i ../input/dataset1/dataset_1_photons_1.hdf5 -t ../output/dataset1/v2/
```
